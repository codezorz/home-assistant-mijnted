...
- **Constants**: Do not hardcode URLs, timeouts, or domain. Use `const.py` (e.g. `DOMAIN`, `API_BASE_URL`, `DEFAULT_POLLING_INTERVAL`). No raw timeouts, status codes, or API paths in the middle of logic — use named constants.
