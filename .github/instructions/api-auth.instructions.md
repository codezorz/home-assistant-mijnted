...
- **Documentation**: When changing or adding API methods, check **doc/ENDPOINTS.md** first (it documents all endpoints), then update it so URLs, parameters, and response shape stay accurate.
