---
applyTo: "custom_components/mijnted/**,README.md,doc/ENDPOINTS.md,doc/SENSORS.md,doc/MONTH_SWITCH.md"
---
...
- **API methods** (`api.py`, endpoints, request/response shape): Check and update **doc/ENDPOINTS.md**. It is the reference for all MijnTed API calls used by the integration. Add new endpoints, fix URLs or parameters, document response structure.
